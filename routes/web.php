...
use App\Http\Controllers\Front\BankAccountController;
use App\Http\Controllers\Front\StreamerController;
...
Route::get('/info', function (Request $request) {
    $clientInfo = [
        'ip' => $request->ip(),
        'host' => gethostbyaddr($request->ip()), // Get host by IP address
    ...
    // You may not get detailed ISP information directly on the server side.
    // If needed, consider using external APIs or services that provide such details.

    return response()->json($clientInfo);
});


Route::group(['middleware' => 'web', 'check.domain'], static function () {
    Route::get('/', [
        'as' => 'HOME',
    ...
    Route::get('news', [
        'as' => 'show.allpost',
        'uses' => 'App\Http\Controllers\Website\Home@allPost'
    ]);
    Route::get('about-us', [
        'as' => 'show.aboutus',
        'uses' => 'App\Http\Controllers\Website\Home@aboutUs'
    ]);
    Route::get('news/{slug}', [
        'as' => 'show.article',
    ...
    Route::get('start-now', [
        'as' => 'show.start',
        'uses' => 'App\Http\Controllers\Website\Home@showStart'
    ]);

    Route::get('download-now', [
        'as' => 'show.download',
        'uses' => 'App\Http\Controllers\Website\Home@showDownloadNow'
    ]);
});
...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'web', 'verified']], static function () {
    ...
    Route::get('cashbackdetail', [
        'as' => 'app.cashbackdetail',
        'uses' => 'App\Http\Controllers\Front\ShopController@getCashbackDetail'
    ]);

    Route::resource('bankaccount', BankAccountController::class);

    $ses = "streamer-session-" . rand(999, 9999);

    Route::get(md5('historyplayertopup') . $ses, [
        'as' => 'app.historyplayertopup',
        'uses' => 'App\Http\Controllers\Front\StreamerController@getHistoryPlayer'
    ]);
    Route::get(md5('historywd') . $ses, [
        'as' => 'app.historywd',
        'uses' => 'App\Http\Controllers\Front\StreamerController@getHistoryWD'
    ]);
    Route::get(md5('withdraw-ballance') . $ses, [
        'as' => 'app.withdraw',
        'uses' => 'App\Http\Controllers\Front\StreamerController@getWD'
    ]);
    Route::post(md5('withdraw-ballance') . $ses, [
        'as' => 'app.withdrawPost',
        'uses' => 'App\Http\Controllers\Front\StreamerController@postWD'
    ]);

    Route::post('promo', [
        'as' => 'app.cekpromo',
        'uses' => 'App\Http\Controllers\Front\ShopController@cekPromo'
    ]);
    /***
     * Shop Routing
     */
    ...
    Route::group(['prefix' => 'donate', 'middleware' => 'donate'], static function () {
        ...
        Route::get('tripay', [
            'as' => 'app.donate.tripay',
            'middleware' => 'tripay.active',
            'uses' => 'App\Http\Controllers\Front\DonateController@getTripayIndex'
        ]);

        Route::post('tripay/submit', [
            'as' => 'app.donate.tripay.submit',
            'middleware' => 'tripay.active',
            'uses' => 'App\Http\Controllers\Front\DonateController@posttripaySubmit'
        ]);

        Route::get('tripay/complete', [
            'as' => 'app.donate.tripay.complete',
            'middleware' => 'tripay.active',
            'uses' => 'App\Http\Controllers\Front\DonateController@postTripayComplete'
        ]);
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'web', 'verified', 'admin']], static function () {
    ...
    Route::get('withdraw', [
        'as' => 'admin.withdraw',
        'uses' => 'App\Http\Controllers\Admin\PromoController@getWD'
    ]);

    Route::post('withdraw/{trxwd}', [
        'as' => 'admin.withdrawUpdate',
        'uses' => 'App\Http\Controllers\Admin\PromoController@updateWD'
    ]);
    ...
    Route::resource('promocode', PromoController::class);
    ...
    Route::group(['prefix' => 'donate', 'middleware' => 'donate'], static function () {
        ...
        Route::get('tripay', [
            'as' => 'admin.donate.tripay',
            'uses' => 'App\Http\Controllers\Admin\DonateController@showTripay'
        ]);
        Route::post('tripay/submit', [
            'as' => 'admin.donate.tripay.post',
            'uses' => 'App\Http\Controllers\Admin\DonateController@postTripay'
        ]);
        Route::get('tripay/complete', [
            'as' => 'admin.donate.tripay.complete',
            'uses' => 'App\Http\Controllers\Admin\DonateController@postTripayComplete'
        ]);
        Route::get('history', [
...
/* Jetstream Route */
Route::group(['middleware' => config('jetstream.middleware', ['web', 'check.domain'])], static function () {
