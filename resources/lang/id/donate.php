...
return [
    ...
    */
    ...
    'tripay' => [
        'title' => 'Tripay',
        'status' => 'Status',
        'status_desc' => 'Pindahkan sakelar ke kanan untuk mengaktifkan Tripay',
        'sandbox' => 'Sandbox',
        'sandbox_desc' => 'Pindahkan sakelar ke mode kotak pasir aktif.',
        'double' => 'Dobel',
        'double_desc' => 'Donasi ganda aktif.',
        'va' => 'Akun Virtual',
        'va_desc' => 'Masukkan Akun Virtual Tripay Anda',
        'merchant_code' => 'Merchant Code',
        'merchant_code_desc' => 'Masukkan Merchant Code Tripay Anda',
        'apikey' => 'Api Key',
        'apikey_desc' => 'Masukkan api Key Tripay Anda',
        'private_key' => 'Private Key',
        'private_key_desc' => 'Masukkan private Key Tripay Anda',
        'currency_per' => ':coin per :currency',
        'currency_per_desc' => 'Masukan jumlah :coin per :currency',
        'minimum' => 'Jumlah minimal',
        'minimum_desc' => 'Jumlah minimum',
