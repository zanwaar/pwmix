    ...
    <x-slot name="content">
        <div class="max-w-sm mx-auto mt-6 rounded-md dark:bg-darker bg-white p-4">
            ...
            <form method="post" action="{{ route('admin.settings.post') }}" enctype="multipart/form-data">
                ...
                <div class="relative z-0 mb-6 w-full group">
                    <x-hrace009::input-with-popover id="fbfp" name="fbfp"
                                                    value="{{ config('pw-config.fbfp') }}" placeholder=" "
                                                    required
                                                    :popover="__('system.fbfp')"
                    />
                    <x-hrace009::label for="fbfp">{{ __('system.fbfp') }}</x-hrace009::label>
                </div>
                <div class="relative z-0 mb-6 w-full group">
                    ...
                    />
                    <x-hrace009::label for="fbfp">{{ __('system.fakeonline') }}</x-hrace009::label>
                </div>
                <div class="relative z-0 mb-6 w-full group">
